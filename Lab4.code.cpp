    ...
    for (int i = 0; i < N; i++)
        {
           ...
           if (way_distance[2][i] < 0)
           {
               cout << "\nРасстояние не может быть отрицательным. Введите расстояние правильно! Расстояние до дома сотрудника: ";
    ...
    for (int i = 0; i < N; i++)
        {
           ...
           if (price[2][i] < 0)
            {
                cout << "\nТариф за такси не может быть отрицательным. Введите тариф правильно! Тариф за проезд одного километра: ";
                cin >> price[2][i];
            }
